part of customsearch_v1_api_console;

/** Client to access the customsearch v1 API */
/** Lets you search over a website or collection of websites */
class Customsearch extends ConsoleClient {
  ...
  Customsearch([Object auth]) : super(auth) {
